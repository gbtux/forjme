 ...
 * @return
 */
function init_chat(chat_id, html_el_id, sync_url, join_url, leave_url, send_url, receive_url, img_dir) {
    ...
    $.ajax({
		...
		success: function (json) {
			...
			if (scroll)
				...
				$("#chat-messages-container").animate({ scrollTop: $("#chat-messages-container")[0].scrollHeight }, 500);
		}        
    });
